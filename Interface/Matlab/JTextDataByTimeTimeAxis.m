function data = JTextDataByTimeTimeAxis( ip, tag, shot, arg1, arg2, arg3 )
% 从服务器上读取HDF5或其它格式的数据，和JTextDataByTime的形式一模一样
...
url = strcat('http://',ip,'/tagserver/databytimetimeaxis/',tag,'/',shot,'/',num2str(arg1),'/',num2str(arg2),'/',num2str(arg3));
