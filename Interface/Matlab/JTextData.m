function data = JTextData( ip, tag, shot, arg1, arg2, arg3, arg4 )
% 从服务器上读取HDF5或其它格式的数据
...
switch(nargin)
    case 3
        url = strcat(url,'/data/',tag,'/',shot);
    case 5
        url = strcat(url,'/data/',tag,'/',shot,'/',num2str(arg1),'/',num2str(arg2));
    case 6
        url = strcat(url,'/datacomplex/',tag,'/',shot,'/',num2str(arg1),'/',num2str(arg2),'/',num2str(arg3));
    case 7
        url = strcat(url,'/datacomplex/',tag,'/',shot,'/',num2str(arg1),'/',num2str(arg2),'/',num2str(arg3),'/',num2str(arg4));
    otherwise
        disp('params error!')
        return
end
